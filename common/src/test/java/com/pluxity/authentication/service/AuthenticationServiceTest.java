...
class AuthenticationServiceTest {
    ...
    void signUp_withDuplicateUsername_shouldThrowException() {
        ...
        CustomException exception =
                assertThrows(CustomException.class, () -> authenticationService.signUp(request));
    }
    ...
    void signOut_withValidRefreshToken_shouldDeleteTokenAndExpireCookies() {
        ...
        Cookie expiryCookie =
                new Cookie("expiry", String.valueOf(System.currentTimeMillis())); // 값은 중요하지 않음
        ...
        assertThat(deletedCookies).noneMatch(c -> c.startsWith(ACCESS_TOKEN_NAME + "="));
    }
