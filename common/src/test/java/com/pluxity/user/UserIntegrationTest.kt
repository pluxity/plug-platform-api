...
internal class UserIntegrationTest {
    ...
    @Autowired
    private lateinit var permissionGroupService: PermissionGroupService // PermissionService -> PermissionGroupService
    ...
    @Autowired
    private lateinit var permissionGroupRepository: PermissionGroupRepository // 추가

    @Autowired
    private lateinit var permissionRepository: PermissionRepository // 추가
