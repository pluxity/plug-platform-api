...
enum class ErrorCode(
    ...
    END_DATE_ALREADY_PASSED(HttpStatus.BAD_REQUEST, "트리거 종료일이 이미 지났습니다 (종료일: %s, 다음 실행일: %s)"),
    START_DATE_AFTER_END_DATE(HttpStatus.BAD_REQUEST, "시작일은 종료일보다 이후일 수 없습니다.(시작일: %s, 종료일: %s)"),
    ;
