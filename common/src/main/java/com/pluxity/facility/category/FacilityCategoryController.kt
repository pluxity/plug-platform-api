...
class FacilityCategoryController(
    private val service: FacilityCategoryService,
) {
    ...
    fun createFacilityCategory(
        ...
        @Valid
        @RequestBody req: FacilityCategoryCreateRequest,
    ): ResponseEntity<Long> = ResponseEntity.ok(service.create(req))
    ...
    fun patchFacilityCategory(
        ...
        @Valid
        @RequestBody request: FacilityCategoryUpdateRequest,
    ): ResponseEntity<Void> {
