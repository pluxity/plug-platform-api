    ...
    public static void main(String[] args) {
        String hexStream =
                ...
                "02 0013 01 B1 00 18 05 0A 0B 0C 0D 77 01 86 86 2166 2168 01 01 AABB 03 " +
                        ...
                        "02 0013 02 B1 00 18 05 0A 0B 0C 0E 78 02 87 87 2167 2169 01 01 CCDD 03 " +
                        // 3. B2(도착) + 01(상행) - Payload: 20(0x14) bytes. StopTime(0E -> 14초) 추가됨.
                        "02 0014 03 B2 00 18 05 0A 0B 0C 0F 79 01 88 88 2168 216A 01 01 0E EEFF 03 " +
                        // 4. B2(도착) + 02(하행) - Payload: 20(0x14) bytes. StopTime(1F -> 31초) 추가됨.
                        "02 0014 04 B2 00 18 05 0A 0B 0C 10 7A 02 89 89 2169 216B 01 01 1F A1B2 03 " +
                        // 5. B3(접근) + 01(상행) - Payload: 19(0x13) bytes
                        "02 0013 05 B3 00 18 05 0A 0B 0C 11 7B 01 8A 8A 216A 216C 01 01 C3D4 03 " +
                        // 6. B3(접근) + 02(하행) - Payload: 19(0x13) bytes
                        "02 0013 06 B3 00 18 05 0A 0B 0C 12 7C 02 8B 8B 216B 216D 01 01 E5F6 03";
