...
@RestController
@RequestMapping("/devices/gs-devices")
...
class GsDeviceController(
    ...
    fun get(): ResponseEntity<DataResponseBody<List<GsDeviceResponse>>> = ResponseEntity.ok(DataResponseBody.of(gsDeviceService.findAll()))
