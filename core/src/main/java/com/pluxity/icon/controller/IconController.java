...
public class IconController {
    ...
    public ResponseEntity<DataResponseBody<IconResponse>> get(
            @Parameter(description = "아이콘 ID", required = true) @PathVariable Long id) {
    ...
    public ResponseEntity<Void> patch(
            @Parameter(description = "아이콘 ID", required = true) @PathVariable Long id,
            @Parameter(description = "아이콘 수정 정보", required = true) @Valid @RequestBody
                    IconUpdateRequest request) {
