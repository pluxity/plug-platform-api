...
internal class RoleServiceTest {
    ...
    @Autowired
    lateinit var permissionGroupService: PermissionGroupService // PermissionService -> PermissionGroupService

    @Autowired
    lateinit var permissionGroupRepository: PermissionGroupRepository // 추가
