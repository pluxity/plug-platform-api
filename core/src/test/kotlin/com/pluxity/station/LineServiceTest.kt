...
internal class LineServiceTest
    ...
    constructor(
        ...
        fun save_WithDuplicateName_ThrowsCustomException() {
            ...
            // when & then
            assertThrows<CustomException> { lineService.save(duplicateNameRequest) }
        }
        ...
        fun findById_WithAssociatedStations_ReturnsLineWithStationIds() {
            ...
            stationService.addLineToStation(station1.requiredId(), lineId)
            stationService.addLineToStation(station2.requiredId(), lineId)
            ...
            // then
            Assertions
                .assertThat(response.stationIds)
                .hasSize(2)
        ...
        fun findById_WithNonExistingId_ThrowsCustomException() {
            ...
            // when & then
            assertThrows<CustomException> { lineService.findById(nonExistingId) }
        }
        ...
        fun update_ToDuplicateName_ThrowsCustomException() {
            ...
            // when & then
            assertThrows<CustomException> { lineService.update(idToUpdate, updateRequest) }
        }
        ...
        fun update_WithNonExistingId_ThrowsCustomException() {
            ...
            // when & then
            assertThrows<CustomException> { lineService.update(nonExistingId, updateRequest) }
        }
        ...
        fun delete_WithExistingId_DeletesLine() {
            ...
            assertThrows<CustomException> { lineService.findById(id) }
        }
        ...
        fun delete_WithNonExistingId_ThrowsCustomException() {
            ...
            // when & then
            assertThrows<CustomException> { lineService.delete(nonExistingId) }
        }
        ...
        fun deleteLine_DeletesAllRelatedStationLines() {
            ...
            stationService.addLineToStation(station.requiredId(), lineId)
            ...
            val stillExistingStation = stationRepository.findById(station.requiredId()).orElseThrow()
